...
class Tab {
  ...
  on() {
    ...
    (0, _jquery.default)(this.triggerElemAll).on(`click.${this.id}`, e => {
  ...
  run(e, index) {
    const indexNumber = typeof index === 'number' ? index : 0,
  ...
  runAll(e, index) {
    ...
    Array.prototype.forEach.call(this.wrapperElemAll, wrapper => {
      const targetElemAll = wrapper.querySelectorAll(this.targetSelector),
      ...
      if (arg.targetElem === null) {
        ...
        if (this.hash === (key === 'id' ? '#' + elem[key] : elem[key])) {
          if (key === 'hash') {
            ...
            this.selectedWrapper = (0, _closest.default)(arg.targetElem, this.wrapperSelector);
          }

...
/* harmony import */ var _js_modules_tab_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../js/_modules/tab.js */ "./src/js/_modules/tab.js");
/* harmony import */ var _js_modules_rescroll_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../js/_modules/rescroll.js */ "./src/js/_modules/rescroll.js");
...
var mdls = {};
mdls.rescroll = new _js_modules_rescroll_js__WEBPACK_IMPORTED_MODULE_2__["default"]({
  offsetTop: '.pl-head'
});
mdls.rescroll.on();
mdls.tab = new _js_modules_tab_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
var Rescroll = /*#__PURE__*/function () {
  ...
  _createClass(Rescroll, [{
    ...
    value: function scroll(target) {
      ...
      window.scrollTo(0, Object(_utilities_offset_js__WEBPACK_IMPORTED_MODULE_2__["default"])(targetElem).top - offsetTop);
    }
  }, {
    key: "lock",
    value: function lock() {
  ...
  _createClass(Tab, [{
    ...
    value: function run(e, index) {
      var indexNumber = typeof index === 'number' ? index : 0,
          ...
          wrapperElem = Object(_utilities_closest_js__WEBPACK_IMPORTED_MODULE_2__["default"])(triggerElem, this.wrapperSelector),
        ...
        if (arg.targetElem === null) {
          ...
          if (_this3.hash === (key === 'id' ? '#' + elem[key] : elem[key])) {
            if (key === 'hash') {
              ...
              _this3.selectedWrapper = Object(_utilities_closest_js__WEBPACK_IMPORTED_MODULE_2__["default"])(arg.targetElem, _this3.wrapperSelector);
            }

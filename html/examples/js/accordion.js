...
mdls.toggle.on((e, instance) => {
  console.info('open');
  const $target = $(instance.elemTarget),
  ...
  const $parent = $(instance.elemToAddClass);
...
},{"../../js/_modules/jqueryhub.js":2,"../../js/_modules/transitiontoggle.js":3}],2:[function(require,module,exports){
"use strict";
...
class Toggle {
  ...
  off() {
    ...
    this.callBackForOpen = null;
    this.callBackForClose = null;
    (0, _jquery.default)(this.eventRoot).off(`transitionend.${this.id}`, this.target);
    return this;
  }

    ...
    value: function runCallBacksAll() {
      ...
      Object.keys(this.callBacks).forEach(function (key) {
        var entry = _this.callBacks[key],
            ...
            scrollFrom = vwTop + catchPoint - (hookPoint + Object(_utilities_offset_js__WEBPACK_IMPORTED_MODULE_1__["default"])(targetElem).top),
...
var VideoGround = /*#__PURE__*/function () {
  ...
  _createClass(VideoGround, [{
    ...
    value: function on() {
      ...
      $(elemVideo).on("play.".concat(this.id), function () {
      ...
      $(elemVideo).one("canplay.".concat(this.id), function () {
        elemVideo.play();

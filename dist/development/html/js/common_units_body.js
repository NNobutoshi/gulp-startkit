...
/* harmony import */ var _libs_transitiontoggle_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./libs/transitiontoggle.js */ "./src/js/_modules/libs/transitiontoggle.js");
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
  ...
  function Accordion(options) {
    ...
    var defaultSettings = this.defaultSettings = {
      ...
      propertyTargetTransition: 'height'
        ...
        settings = this.settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_7__({}, defaultSettings, options);
  ...
  _createClass(Accordion, [{
    ...
    value: function setUp() {
      ...
      Array.prototype.forEach.call(this.elemParentAll, function (elemParent, index) {
        var toggle = new _libs_transitiontoggle_js__WEBPACK_IMPORTED_MODULE_6__["default"]({
          name: _this.id + index,
...
/* harmony import */ var core_js_modules_es_string_replace_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es.string.replace.js */ "./node_modules/core-js/modules/es.string.replace.js");
/* harmony import */ var core_js_modules_esnext_string_replace_all_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/modules/esnext.string.replace-all.js */ "./node_modules/core-js/modules/esnext.string.replace-all.js");
/* harmony import */ var _polyfills_matches_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../polyfills/matches.js */ "./src/js/_modules/polyfills/matches.js");
...
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
  ...
  function AdaptiveHover(options) {
    ...
    var defaultSettings = this.defaultSettings = {
      ...
      coverage: 20
        ...
        settings = this.settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_6__({}, defaultSettings, options);
    this.id = settings.name;
    this.selectorTarget = settings.selectorTarget;
...
var OptimizedResize = /*#__PURE__*/function () {
  ...
  _createClass(OptimizedResize, [{
    ...
    value: function add(callback, options) {
      var settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_6__({}, {
        // default
...
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
/* harmony import */ var _utilities_position_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../utilities/position.js */ "./src/js/_modules/utilities/position.js");
  ...
  function ScrollManager(options) {
    ...
    var defaultSettings = this.defaultSettings = {
      ...
      catchPoint: '100%'
        ...
        settings = this.settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_13__({}, defaultSettings, options);
    this.id = settings.name;
    this.selectorEventRoot = settings.selectorEventRoot;
  ...
  _createClass(ScrollManager, [{
    ...
    value: function runCallbacksAll() {
      ...
      for (var key in this.callbacks) {
        var entry = this.callbacks[key],
            ...
            scrollFrom = viewTop + catchPoint - (hookPoint + (0,_utilities_position_js__WEBPACK_IMPORTED_MODULE_14__["default"])(elemTarget).top),
            ratio = scrollFrom / range;

        entry.observed = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_13__(entry.observed, {
          name: entry.name,
    ...
    value: function add(callback, elemTarget, options) {
      var defaultOptions = {
        ...
        observed: {}
          ...
          entry = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_13__({}, defaultOptions, options);
    ...
    value: function setUp() {
      ...
      if (!this.callbacks.length) {
        this.eventRoot = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_16__["default"](this.elemEventRoot);
...
var TtransitionToggle = /*#__PURE__*/function () {
  ...
  _createClass(TtransitionToggle, [{
    key: "on",
    value: function on(callbacks) {
      this.eventRoot = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_5__["default"](this.elemEvtRoot);
...
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
/* harmony import */ var _utilities_parents_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utilities/parents.js */ "./src/js/_modules/utilities/parents.js");
  ...
  function Locate(options) {
    ...
    var defaultSettings = this.defaultSettings = {
      ...
      indexRegex: /index\.[^/]+?$/
        ...
        settings = this.settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_12__({}, defaultSettings, options);
    this.id = settings.name;
    this.selectorTarget = settings.selectorTarget;
    this.selectorParent = settings.selectorParent;
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (hostNameByLocal !== hostNameByElement) {
            ...
            this.elemParentAll = (0,_utilities_parents_js__WEBPACK_IMPORTED_MODULE_13__["default"])(this.elemCurrent, this.selectorParent, 'body');
          }
        } // for
...
/* harmony import */ var _utilities_position_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./utilities/position.js */ "./src/js/_modules/utilities/position.js");
/* harmony import */ var _polyfills_closest_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./polyfills/closest.js */ "./src/js/_modules/polyfills/closest.js");
/* harmony import */ var _vendor_raf_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../_vendor/raf.js */ "./src/js/_vendor/raf.js");
...
var Rescroll = /*#__PURE__*/function () {
  ...
  _createClass(Rescroll, [{
    ...
    value: function preprocess(e, target) {
      ...
      if (e.type === 'click' && target && target.hash && elemShoulder && (0,_utilities_position_js__WEBPACK_IMPORTED_MODULE_14__["default"])(target).top === (0,_utilities_position_js__WEBPACK_IMPORTED_MODULE_14__["default"])(elemShoulder).top || this.isWorking === true || this.enabled === false || !elemByHash && !elemShoulder) {
        this.isWorking = false;
        return this;
      }
      /**
    ...
    value: function scroll(elemTarget) {
      var finishPoint = (0,_utilities_position_js__WEBPACK_IMPORTED_MODULE_14__["default"])(elemTarget).top - this.offset();
    ...
    value: function animatedScroll(elemTarget) {
      var duration = this.settings.animeOption.duration,
          ...
          finishPoint = (0,_utilities_position_js__WEBPACK_IMPORTED_MODULE_14__["default"])(elemTarget).top - this.offset(),
...
var SimpleVideoPlay = /*#__PURE__*/function () {
  ...
  _createClass(SimpleVideoPlay, [{
    ...
    key: "on",
    value: function on(callbacks) {
      this.eventVideo = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_6__["default"](this.elemVideo);
      this.eventCover = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_6__["default"](this.elemCover);
      this.callbackBefore = callbacks.before.bind(this);
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator.js */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
/* harmony import */ var _polyfills_closest_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./polyfills/closest.js */ "./src/js/_modules/polyfills/closest.js");
...
var Tab = /*#__PURE__*/function () {
  ...
  _createClass(Tab, [{
    ...
    value: function on(callbacks) {
      ...
      this.eventRoot = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_15__["default"](this.elemEventRoot);
...
/* harmony import */ var lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! lodash/mergeWith.js */ "./node_modules/lodash/mergeWith.js");
/* harmony import */ var _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./libs/eventmanager.js */ "./src/js/_modules/libs/eventmanager.js");
...
var VideoGround = /*#__PURE__*/function () {
  function VideoGround(options) {
    ...
    var defaultSettings = this.defaultSettings = {
      ...
      attrVideo: ['muted', 'playsinline', 'loop']
        ...
        settings = this.settings = lodash_mergeWith_js__WEBPACK_IMPORTED_MODULE_21__({}, defaultSettings, options);
    this.id = settings.name;
    this.selectorParent = settings.selectorParent;
  ...
  _createClass(VideoGround, [{
    ...
    value: function on(callbacks) {
      ...
      this.eventVideo = new _libs_eventmanager_js__WEBPACK_IMPORTED_MODULE_22__["default"](this.elemVideo);

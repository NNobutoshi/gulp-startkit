...
const mdls = {};
const elemInputCatch = document.querySelector('.pl-input--catchPoint');
let catchPoint = 0;
mdls.scrollManager = new _js_modules_libs_scrollmanager_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
  catchPoint: '100%',
...
function _handle(observed) {
  const elemInputHook = observed.elemInput || observed.target.querySelector('.pl-input--hookPoint'),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["./js/common_modules_body","./examples/js/common_modules"], () => (__webpack_require__("./src/examples/js/inview.entry.js")))
